					...
					<div class="breadcrumbs-top">
						...
						<div class="breadcrumb-wrapper d-none d-sm-block">
							<ol class="breadcrumb p-0 mb-0 pl-1">
								...
								<li class="breadcrumb-item active">List Package</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body card-dashboard">
								...
								<a href="package_add.php" style="color:White;"><i class="bx bx-plus"></i>&nbsp; Add New Package </a></button>	
											...
											?>
												<tr>
												   ...
												   <td><span class="form-check form-switch">
															...
															<?php if($data['package_status'] == '1') { echo 'checked'; } ?>
															onclick="toggleStatus( <?php echo $data['package_id']; ?> )"/>
														</span>
													</td>
													
													<td>
														<a onclick="return confirm('Are you sure you want to delete this Package?');" href="package_delete.php?package_id=<?php echo $data['package_id']; ?>"><i class="bx bx-trash mr-1" style="font-size:20px;color:grey;"></i></a>  
														<a href="package_add.php?package_id=<?php echo $data['package_id']; ?>"> <i class="bx bx-edit-alt mr-1" style="font-size:20px;color:grey;"></i></a>
													</td>
												</tr>
											<?php		  
												}
...
<script>
	function toggleStatus(package_id)
	{
		$.ajax({
			url: "change_status.php",
			type: "POST",
			data: { p_id: package_id },

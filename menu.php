...
<div class="menu-pop menu-pop1">
	...
	<div class="inn">
		...
		<p><strong> Vivahmilan</strong>  Uniting Souls, Creating Everlasting Love!" 💍❤️</p>
		<ul class="menu-pop-info">
			<li><a href="#!"><i class="fa fa-phone" aria-hidden="true"></i>+91 99986 75436</a></li>
			<li><a href="#!"><i class="fa fa-whatsapp" aria-hidden="true"></i>+91 99748 29964</a></li>
		...
		<div class="menu-pop-help">
			<h4>Support Team</h4>
			<div class="user-pro">
				<img src="./admin/admin_profiles/admin.jpg " alt="" loading="lazy">
			</div>
			<div class="user-bio">
				<h5>Vivahmilan</h5>
				<ul>
						...
						<li class="smenu-pare">
							...
							<div class="smenu-open smenu-single">
								<ul>
									...
									<li><a id="deleteAccountLink">Delete Account</a></li>
								</ul>
							</div>
						</li>
						<?php } ?>
    ...
    document.getElementById("deleteAccountLink").addEventListener("click", function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Redirect to PHP delete page with member_id
                window.location.href = "delete_member_account.php?member_id=<?php echo $_SESSION['member_id']; ?>";
            }
        });
    });
</script>

...
<html class="loading" lang="en" data-textdirection="ltr">
	...
	<head>
		...
		<title>Member Details | <?php echo $WEB_TITLE;?></title>
									...
									<tbody>
										<?php
											...
											$str="SELECT * 
													...
													JOIN sub_community_tbl ON member_detail_tbl.member_sub_community_id = sub_community_tbl.sub_community_id
													WHERE member_tbl.member_status = 1
													ORDER BY member_detail_tbl.member_detail_id DESC
													LIMIT 0, 30;";
										...
										?>
												<tr>
													...
													<td><?php echo ucfirst($data['member_religion']); ?></td>
													<td><?php echo ucfirst($data['marital_status']); ?></td>
													<td><?php echo ucfirst($data['member_birthplace']); ?></td>
													<td><?php echo ucfirst( $data['member_rashi']); ?></td>
												</tr>
										<?php		  
											}
										?>

...
<?php
	...
	$str="select * from community_tbl ORDER BY community_id desc";
					...
					<h5 class="content-header-title float-left pr-1 mb-0">Community</h5>
						<div class="breadcrumb-wrapper d-none d-sm-block">
							<ol class="breadcrumb p-0 mb-0 pl-1">
								...
								<li class="breadcrumb-item active">List Community</li>
							</ol>
						</div>
					</div>
				</div>
												...
												?>
													<tr>
														...
														<td><span class="form-check form-switch">
																...
																<?php if($data['community_status'] == '1') { echo 'checked'; } ?>
																onclick="toggleStatus( <?php echo $data['community_id']; ?> )"/>
															</span>
														</td>
														<td>
															<a onclick="return confirm('Are you sure you want to delete this Community?');" href="community_delete.php?community_id=<?php echo $data['community_id']; ?>"><i class="bx bx-trash mr-1" style="font-size:20px;color:grey;"></i></a>
															<a href="community_add.php?community_id=<?php echo $data['community_id']; ?>"> <i class="bx bx-edit-alt mr-1" style="font-size:20px;color:grey;"></i></a>
														</td>
													</tr>
												<?php		  
													}
...
<script>
	  function toggleStatus(community_id)
	  {
		  $.ajax({
			url: "change_status.php",
			type: "POST",
			data: { c_id: community_id },

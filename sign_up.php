...
<body>
                        ...
                        <div class="rhs">
                            <div>
                                ...
                                <div class="form-login">
									...
									?>
                                    <form method="POST" id="form-registration" name="form_name" autocomplete="off" action="sign_up1.php">
                                        <div class="form-group">
											<label class="lb" style="color: #5b2a07;">Looking For:</label>
											<!-- Looking For -->
											<select id="looking_for" class="form-control form-select chosen-select" data-placeholder="Select Looking For" onChange="get_gender(this.value);" name="looking">
												<option selected disabled value="" required>-Select Looking For-</option>
                                        ...
                                        <div class="form-group">
											...
											<!-- Profile For -->
                                            <select id="profile_for" class="form-control ProfileFor" data-placeholder="Select Profile For" name="profilefor">
												<option selected disabled value="">-Select Profile For-</option>
											</select>
                                        </div>
										<div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- Email -->
											<input type="email" id="email" class="form-control" name="email" placeholder="e.g. email@address.com">
										...
										<div class="form-group form-check">
											<label class="form-check-label">
												...
												<input type="checkbox" id="checkme" name="checked"> I agree to the Terms and Conditions
											</label>
										</div>
										<!-- Submit Button -->
	...
	function get_gender(val) {
		//alert('hi'+val);
			...
			$(document).ready(function () {
			$('#email').on('blur', function () { // When user leaves the email input
				var email = $(this).val().trim(); // Trim spaces
					...
					$.ajax({
						...
						success: function (response) {
							if (response.trim() === 'exists') {
								$('#email-error').show(); // Show error message
								$('#email').addClass('is-invalid'); // Add Bootstrap error styling
							} else {
								$('#email-error').hide(); // Hide error message
								$('#email').removeClass('is-invalid'); // Remove error styling
							}
						}
					});
				}

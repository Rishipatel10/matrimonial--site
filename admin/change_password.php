<?php
	...
	{
		$qry="select * from admin_tbl where admin_email='".$_SESSION["Email"]."'";
		$test=mysqli_query($conn,$qry);
		$result=mysqli_fetch_array($test); 
		$old_pwd=$result['admin_password'];
 
		if($old_pwd==$_POST['currpwd'])
		{
			if($_POST['newpwd']===$_POST['cfmpwd'])
			{
				$str="update admin_tbl set admin_password='".$_POST['newpwd']."' where admin_email='".$_SESSION["Email"]."'";
				mysqli_query($conn,$str);
				echo "echo <script>alert('Password Changed Sucessfully..');window.location.href='index.php';</script>;";
			}
			else
			{
...
<html class="loading" lang="en" data-textdirection="ltr">
	...
	<head>
		...
		<title>Change Password | <?php echo $WEB_TITLE;?></title>

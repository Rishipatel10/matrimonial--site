            ...
            <table class="table zero-configuration">
              ...
              <tbody>
			      <?php
					  ...
					  {
						  echo "<tr><td>".$data['community_id']."</td>";
						  echo "<td>".$data['community_name']."</td>";?>
						  <td><a href="community_delete.php?community_id=<?php echo $data['community_id'];?>">
						 <i class="bx bx-trash mr-1" style="font-size:25px;color:red;"></i></a></td></tr>

                    ...
                    <html>
						...
						<body>
							<div class="c-email" style="width:60%;margin:auto;border:1px solid #BAE3FF;border-radius:5px;padding:30px 30px 12px 30px;">
								<div style="text-align:center">Vivahmilan</div>
								...
								<div style="font-size:10px;font-family:roboto;color:#383838;text-align:center">
									<o>Thank you for utilising our services</o><br><o>-</o><br>
									<o>Vivahmilan</o><br>
									<o>7990212140, 9723785500</o><br>
					...
					<div class="card-body">
						...
						<div class="app-brand justify-content-center">
							<a href="index.php" class="app-brand-link gap-2">
								...
								<span class="app-brand-text demo h3 mb-0 fw-bold"><h1 style=" margin-left: 129px;">Vivahmilan</h1></span>
						...
						<center><form id="formAuthentication" class="mb-3" method="POST" >
							<div class="mb-3">
								<label for="email" class="form-label">Email</label>
								<input type="email" class="form-control" id="email" name="eid" placeholder="Enter your email" <input type="email" class="form-control" id="email" name="eid" placeholder="Enter your email" autofocus="" style="width:278px" autofocus>
							</div>
							<br>

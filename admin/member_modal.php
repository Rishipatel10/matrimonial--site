...
<?php
	...
	$sql = "Select * from member_tbl,member_detail_tbl,community_tbl,sub_community_tbl,state_tbl,city_tbl,
			...
			state_tbl.state_id=city_tbl.state_id and member_tbl.member_city=city_tbl.city_id and 
							...
							<div> <!-- <div class="d-flex flex-column align-items-center text-center"> -->
								...
								<div class="mt-3">
									<span class="text-secondary" style="font-size: 16px;"><?php echo "# " . $member_profile_id . " - ";?>
										<span><b ><?php echo ucfirst($member_lname). " " . ucfirst($member_fname); ?><?php echo " [". ucfirst($member_gender) ."]"?></b></span>
									</span>
									<p class="text-muted" style="font-size: 10px;"><?php echo ucfirst($member_description);?></p><br><br><br><br><div></div><div></div><div></div><div></div><div></div>
									...
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Community</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($community_name) . "  -  ". ucfirst($member_subcommunity_name) ;?></div>
									</div>
									<hr>
										<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">CasteNo Bar</h6></div><div class="col-sm-6 text-secondary">
											<?php 
												if($caste_no_bar == 1)
												{
													echo "Yes";
									...
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Family / Childrens</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_with_family) . " / " . ucfirst($member_childrens);?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Height / Weight (PX)</h6></div><div class="col-sm-6 text-secondary"><?php echo $member_height . " / ". $member_weight;?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Body type</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_body_type);?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Complexion</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_complexion);?></div>
									</div>
					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									<?php echo ucfirst($member_state) . "  -  ". ucfirst($member_city); ?>
								</div>
							</div>
							<hr>
							<div class="row">
								...
								<div class="col-sm-4 text-secondary">
									<?php echo date("d-M-Y" , strtotime($member_dob)) . "  " . $member_age."-Y"; ?><br>  
								</div>
								<div class="col-sm-2">
							...
							<div class="row">
								...
								<div class="col-sm-4 text-secondary">
									<?php echo ucfirst($member_profile_for); ?>
								</div>
								<div class="col-sm-2">
									<h6 class="mb-0">Looking for</h6>
								</div>
								<div class="col-sm-3 text-secondary">
									<?php echo ucfirst($member_looking_for) ."<br>(Age : ". $member_min_age . " - " . $member_max_age . ")"; ?>
								</div>
							</div>
							<hr>
							<div class="row"> 
								...
								<div class="col-sm-9 text-secondary">
									<?php
										echo $package_name . " - ₹" . $package_price . " for " . $package_duration . "M" . " (" . date("d-M-Y" , strtotime($purchase_date)) . " to " . date("d-M-Y" , strtotime($package_exp_date)) . ")"; 
									?>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 mb-3">
							<div class="card h-100">
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Qualification</h6></div><div class="col-sm-6 text-secondary"><?php echo strtoupper($member_qualification); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Work With</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_work_with); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Occupation</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_occupation); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Designation</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_designation); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Company Name</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_company_name); ?></div>
									</div>
									<hr>
									<div class="row">
						...
						<div class="col-sm-6 mb-3">
							<div class="card h-100">
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Bloodgroup</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($bloodgroup); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Hobbies</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($hobbies_interest); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Diet</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($member_diet); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Language Known</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($language_known); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Residential Known</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($residential_status); ?></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-sm-6"><h6 class="mb-0">Smoking Habbits</h6></div><div class="col-sm-6 text-secondary"><?php echo ucfirst($smoking_habbits); ?></div>
									</div>
									<hr>
									<div class="row">

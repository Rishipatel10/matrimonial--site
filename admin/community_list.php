						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body card-dashboard">
									<p class="card-text">DataTables has most features enabled by default, so all you needto do to 
									...
									<div class="table-responsive">
										<table class="table zero-configuration">
											...
											<tbody>
												...
												?>
													<tr>
														<td><?php echo $data['community_id']; ?></td>
														<td><?php echo $data['community_name']; ?></td>
														<td>
															<a href="community_delete.php?community_id=<?php echo $data['community_id']; ?>"><i class="bx bx-trash mr-1" style="font-size:25px;color:red;"></i></a>
															<a href="community_add.php?community_id=<?php echo $data['community_id']; ?>"> <i class="bx bx-edit-alt mr-1" style="font-size:25px;color:blue;"></i></a>
														</td>
													</tr>
												<?php		  
													}

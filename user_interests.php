												...
												<div class="db-inte-prof-list">
													<ul>
														...
														<li>
															...
															<div class="db-int-pro-3">
																<button type="button" class="btn btn-outline-success btn-sm accept-btn" 
...
<script>
    ...
    // 🟡 Listen for request updates from other tabs/browsers
    ...
    // 🔄 Optional fallback - refresh every 30 sec
			...
			if (result.isConfirmed) {
				$.ajax({
					...
					success: function (response) {
						...
						// ✅ Reload Friend List tab content
						$('#menu2').load(location.href + " #menu2>*", function () {
							console.log("Friend list updated.");

							// ✅ Activate Friend List tab
							var triggerEl = document.querySelector('[data-bs-toggle="tab"][href="#menu2"]');
							if (triggerEl) {
								var tab = new bootstrap.Tab(triggerEl);
								tab.show();

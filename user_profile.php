...
<!-- Dream Class By user-profile.html  [XR&CO'2014], Fri, 14 Feb 2025 06:49:32 GMT -->
<head>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-6 col-xl-8 db-sec-com">
                                    ...
                                    <div class="db-profile">
                                        <div class="img">
                                            <img src="member_profiles/<?php echo $imgVendorSet; ?>" style="height: 344px;width: 286px;" loading="lazy" alt="">
                                        </div>
                                        <div class="edit">
                                            <a href="user_profile_edit.php?member_id=<?php echo $_SESSION['member_id'];?>" class="cta-dark" >Edit profile</a>
                                        </div>
                                    </div>
                                </div>

									...
									<tbody>
										...
										?>
											<tr>
												...
												<td style="padding: 5px;"><?php echo date("d-M-Y" , strtotime($data['member_dob'])); ?></td>
												...
												<td><a onclick="return confirm('Are you sure you want to delete this Member?');" href="member_delete.php?member_id=<?php echo $data['member_id'];?>"><i class="bx bx-trash mr-1" style="font-size:20px;color:grey;"></i></a></td>
											</tr>
										<?php		  
											}
										?>
